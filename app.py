...
# --- 2. CSS SIÊU CÔNG NGHỆ (TẬP TRUNG FIX NÚT KÍCH HOẠT) ---
st.markdown('''
<style>
    /* Tổng thể nền */
    .stApp {
    ...
    /* =========================================
       PHẦN SỬA ĐỔI CHÍNH: NÚT KÍCH HOẠT HỆ THỐNG
       ========================================= */
    div.stButton > button {
        background: linear-gradient(90deg, #0047AB 0%, #0072ff 100%) !important;
        color: white !important;           /* Chữ trắng tuyệt đối */
        font-weight: 800 !important;        /* Chữ siêu đậm */
        font-size: 1.2rem !important;       /* Chữ to rõ */
        text-transform: uppercase !important; /* In hoa chuyên nghiệp */
        letter-spacing: 1.5px !important;    /* Khoảng cách chữ thoáng */
        border: none !important;
        border-radius: 12px !important;
        padding: 12px 25px !important;
        width: 100% !important;
        opacity: 1 !important;              /* Khử hoàn toàn độ trong suốt */
